...
class Language(models.Model):
    ...
    name = models.CharField(max_length=200, help_text='Enter a book language (e.g. Hindi)')
...
def user_directory_path(instance, filename):
    ...
    return 'user_{0}/{1}'.format(instance.django_id.id, filename)
